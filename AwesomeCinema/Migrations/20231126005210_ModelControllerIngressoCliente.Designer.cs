...
namespace AwesomeCinema.Migrations
{
    ...
    [Migration("20231126005210_ModelControllerIngressoCliente")]
    partial class ModelControllerIngressoCliente
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AwesomeCinema.Models.Cliente", b =>
                {
            ...
            modelBuilder.Entity("AwesomeCinema.Models.Ingresso", b =>
                {
            ...
            modelBuilder.Entity("AwesomeCinema.Models.Ingresso", b =>
                {
                    b.HasOne("AwesomeCinema.Models.Cliente", "Cliente")
                        .WithMany()
                        .HasForeignKey("ClienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AwesomeCinema.Models.Exibicao", "Exibicao")
                        .WithMany()
                        .HasForeignKey("ExibicaoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Cliente");

                    b.Navigation("Exibicao");
                });
